...
<section id="advertisement" style="display:none;flex-direction:column;align-items:center;">
...
<script>
// Configurations and Labels for Each Module
const folders=[
